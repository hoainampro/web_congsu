...
class acf_field_flexible_content extends acf_field
{
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		$this->settings['dir'] = THEME_URL.'/core/acf-addon/acf-flexible-content/';
		wp_register_script( 'acf-js-flexible-content', $this->settings['dir'] . 'js/input.js', array('acf-input'), $this->settings['version']);
		wp_register_style( 'acf-css-flexible-content', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['version'] ); 
		
		
		// scripts
		wp_enqueue_script(array(
			'acf-js-flexible-content',	
		));

		// styles
		wp_enqueue_style(array(
			'acf-css-flexible-content',	
		));
