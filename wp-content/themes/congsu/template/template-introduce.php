		...
		<div class="row">
			<div class="col-m-12 col-sm-6 col-xs-12">
				<div class="introduce_detail">
					<h3 class="title_introduce">Trang Chủ<span><a href="">Giới Thiệu</a></span></h3>
				</div>
			</div>
		</div>
	</div>
...
<section id="main-content" class="main-content" role="main">
	<div class="container">
		<div class="services_cos">
			<h2 class="title_service text-center"><span>Giới Thiệu</span></h2>
		</div>
		<div class="row ">
			<?php get_sidebar('left'); ?> 
				<div id="main-column colum_introduce" class="<?php flex_col(); ?>" >
					<div class="introduce_content">
						<div class="img"> 
							<img class="img-responsive" src="/congsuc/wp-content/uploads/2017/11/intro1.jpg" alt="">
							<div>
								<a target="_blank" href="/congsuc/wp-content/uploads/2017/11/intro1.jpg" style="padding:8px 15px;" class="btm-border">Tải hồ sơ năng lực 
