...
class acf_field_gallery extends acf_field
{
	...
	*/
	...
	function input_admin_enqueue_scripts()
	{
		...
		$this->settings['dir'] = THEME_URL.'/core/acf-addon/acf-gallery/';
		wp_register_script( 'acf-js-gallery', $this->settings['dir'] . 'js/input.js', array('acf-input'), $this->settings['version'] );
		wp_register_style( 'acf-css-gallery', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['version'] ); 
