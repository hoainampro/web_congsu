		...
		<div class="row">
			<div class="col-m-12 col-sm-6 col-xs-12">
				<div class="introduce_detail">
					<h3 class="title_introduce">Trang Chủ<span><a href="">Báo Giá</a></span></h3>
				</div>
			</div>
		</div>
	</div>
</section>
<section id="main-content" class="main-content inforprice" role="main">
	<div class="container">
		<div class="services_cos">
			<h2 class="title_service text-center"><span>Báo Giá</span></h2>
		</div>
		<h3 class="title_price text-center">BẢNG BÁO GIÁ IN DECAL, IN BẠT HIFLEX</h3>
		<div class="row">
	...
	<div class="container">
		<table class="table" id="table_price">
		    <thead>
		      <tr>
		        <th>chất liệu</th>
		        <th>gia công</th>
		        <th>Đơn giá<br>VNĐ/m2</th>
		        <th>Đơn giá<br>>5 triêu(VNĐ/m2</th>
		        <th>Đơn giá<br>>10 triêu(VNĐ/m2</th>
		        <th>Đơn giá<br>>20 triêu(VNĐ/m2</th>
		      </tr>
		    </thead>
		    <tbody>
		      <tr>
		        <td>pp ngoài trời</td>
		        <td>cán màng bóng mờ</td>
		        <td>75.000</td>
		        <td>75.000</td>
		        <td>75.000</td>
		        <td>75.000</td>
		 ...
		 <h3 class="title_price text-center">BÁO GIÁ BẢNG HIỆU, HỘP ĐÈN QUẢNG CÁO GIÁ RẺ TẠI ĐÀ NẴNG</h3>
		 <table class="table" id="table_price">
		    <thead>
		      <tr>
		        <th>chất liệu</th>
