...
class Ai1ec_Calendar_Page extends Ai1ec_Base {
	...
	public function get_content(
		...
		if (
			...
			$curent_sid = get_current_blog_id();
			$curent_surl = get_site_url();
			global  $pl_options;
			if(function_exists('pf_show_link')){
			 	$pf_show_link = pf_show_link();
			}else{
				$pf_show_link = '';
			}
			$filter_args = array(
				...
				'tags'                         => $tags,
				'curent_sid'                   => $curent_sid,
				'schedule_down'                => (isset($pl_options['schedule_down']))?$pl_options['schedule_down']:'',
				'site_url'                     => $curent_surl,
				'pf_show_link'                     => $pf_show_link,
